...
@section('content')
    <div class="py-4">
        <form class="rounded" action="{{ route('input.penerbangan.proses') }}" method="POST"
            ...
            <input type="hidden" class="form-control" name="airline_id" id="airline_id" value="{{ auth()->user()->airline_id }}"
                placeholder="">
            <div class="mb-2">
            ...
            <div class="mb-2">
                ...
                <input type="date" class="form-control" name="arrival_date" id="arrival_date"
                    placeholder="Masukkan Tanggal Tiba">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="time" class="form-control" name="arrival_time" id="arrival_time"
                    placeholder="Masukkan Waktu Tiba">
            </div>

            <div class="mb-2">
                <label for="seat_availability" class="form-label py-2">Jumlah Kursi</label>
                <input type="number" class="form-control" name="seat_availability" id="seat_availability"
